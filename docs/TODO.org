...
** DONE Implement WTForms

** Implement Flask-Security

* Notes for the next talk with Ian

** Flask-Security 

We need to configure flask-security.  I want your opinion on this.

*** are we going to use account confirmation?
SECURITY_CONFIRMABLE

**** TODO add confirmed_at to member model 

*** Are we going to enable tracking?
SECURITY_TRACKABLE

**** TODO add these to member model:

***** TODO last_login

***** TODO current_login_at

***** TODO last_login_ip

***** TODO current_login_ip
...
*** Flask-Security
I should hack on this for a little while today to get down exactly what I know and what I need
