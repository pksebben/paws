...
** DONE structure fundraiser data?
I kind of wish I had some backup on this but might as well do the basics
** DONE set all the text on the site to the generic text module
** TODO implement modals for login
might need kirby for this
** TODO hashing [0/2]
*** TODO Basic hashing
*** TODO salt bae tha hashes
** TODO Implement user avatars sitewide
** DONE Wire up leaderboard
** TODO fundraisers page
** DONE check that user profile updating isnt broken and maybe fix it
...
** DONE Implement fundraisers / wire up fundraiser module [3/3]
*** DONE make some juicy schema
*** DONE wire up a lil bit of fixture deliciousness.  Not a lot, baby gurrrrl.
*** DONE Test Drive for no money down and 0% APR for 69 months
** TODO remove leaderboard standalone
** TODO implement flask-login manager
** TODO change all 'name' fields to 'handle'
** DONE move name from auth to member
** DONE integrate profile into member
